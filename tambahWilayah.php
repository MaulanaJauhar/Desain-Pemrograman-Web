        ...
        if (tambahWilayah($_POST) > 0) {
          ...
          echo "
            <script>
              ...
              document.location.href = 'tambahWilayah.php';
            </script>";
        }
      }
?>
                ...
                <div class="col-6 justify-content-center align-items-center">
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <li class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="Kawasan" class="form-control" id="Kawasan" placeholder="Masukkan Kawasan">
                                    </div>
                                </li>
                                <li class="mb-3 row">
                                    <label for="Prefektur" class="col-sm-2 col-form-label">Prefektur</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="Prefektur" class="form-control" id="Prefektur" placeholder="Masukkan Prefektur">
                                    </div>
                                </li>
                                <li class="mb-3 row">
                                    <label for="Ibukota" class="col-sm-2 col-form-label">Ibukota</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="Ibukota" class="form-control" id="Ibukota" placeholder="Masukkan Ibukota">
                                    </div>
                                </li>
                                <li class="mb-3 row">
                                    <label for="Pulau" class="col-sm-2 col-form-label">Pulau</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="Pulau" class="form-control" id="Pulau" placeholder="Masukkan Pulau">
                                    </div>
                                </li>
                                <li class="mb-3 row">
                                    <div class="col">
