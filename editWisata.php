    ...
    if(isset($_POST['submit']))
    {
        ...
        if(editWisata($_POST)>0)
        {
            ...
            <script>
                ...
                document.location.href='editWisata.php';
             </script>";
            echo "<br>";
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                            <ul>
                                ...
                                <li class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="Keterangan" class="form-control" id="Keterangan" value="<?= $wisata['Keterangan']?>">
                                    </div>
                                </li>
                                <li class="mb-3 row">
                                    <label for="Prefektur" class="col-sm-2 col-form-label">Lokasi</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="Prefektur" class="form-control" id="Prefektur" value="<?= $wisata['Prefektur']?>">
                                    </div>
                                </li>
                                <li class="mb-3 row">
                                    <label for="Biaya" class="col-sm-2 col-form-label">Biaya</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="Biaya" class="form-control" id="Biaya" value="<?= $wisata['Biaya']?>">
                                    </div>
                                </li>
                                <li class="mb-3 row">
                                    <label for="Buka" class="col-sm-2 col-form-label">Buka</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="Buka" class="form-control" id="Buka" value="<?= $wisata['Buka']?>">
                                    </div>
                                </li>
                                <li class="mb-3 row">
