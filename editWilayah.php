<?php 
    ...
    $wilayah=query("SELECT * FROM wilayah WHERE id=$id")[0];
    //var_dump($mhs[0]["Nama"]);
    ...
    if(isset($_POST['submit']))
    {
        ...
        if(editWilayah($_POST)>0)
        {
            ...
            <script>
                ...
                document.location.href='editWilayah.php';
             </script>";
            echo "<br>";
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        <ul>
                                <li class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="Kawasan" class="form-control" id="Kawasan" value="<?= $wilayah['Kawasan']?>">
                                    </div>
                                </li>
                                <li class="mb-3 row">
                                    <label for="Prefektur" class="col-sm-2 col-form-label">Prefektur</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="Prefektur" class="form-control" id="Prefektur" value="<?= $wilayah['Prefektur']?>">
                                    </div>
                                </li>
                                <li class="mb-3 row">
                                    <label for="Ibukota" class="col-sm-2 col-form-label">Ibukota</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="Ibukota" class="form-control" id="Ibukota" value="<?= $wilayah['Ibukota']?>">
                                    </div>
                                </li>
                                <li class="mb-3 row">
                                    <label for="Pulau" class="col-sm-2 col-form-label">Pulau</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="Pulau" class="form-control" id="Pulau" value="<?= $wilayah['Pulau']?>">
                                    </div>
                                </li>
                                <li class="mb-3 row">
                                    <div class="col">
